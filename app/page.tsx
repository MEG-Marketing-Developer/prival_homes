    ...
    <>
      <div className="hero-clip-path relative hero min-h-screen -mt-16 ">
        ...
        <div className="hero-content text-center text-neutral-content">
          <div className="max-w-4xl">
            ...
            <button className="btn main-color rounded-full px-20 pt-6 pb-12 text-2xl">
              <Link href={"/properties"} className="uppercase tracking-wide">
                Book Now
              </Link>
            </button>
          </div>
      ...
      <div className="hero-clip-path">
        <div className="container mx-auto p-6 my-5">
          <div>
            ...
            <p className="tracking-normal text-center sm:text-left text-3xl text-[#161615]">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 items-center mt-20">
      ...
      <div className="hero-clip-path bg-[#DDDDDD]">
        <div className="container mx-auto pb-40 pt-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mb-10 gap-2 mx-20 sm:mx-2">
            <div className="min-h-[620px] max-w-[470px]">
              <div className="relative min-h-[450px] md:min-h-[600px] max-w-[470px]">
                <Image
                  src={downtown}
                  alt="downtown-img"
                  fill
      ...
      <div className="hero-clip-path">
        <div className="container mx-auto p-6">
          <div>
            <h1 className="main-color mt-20 mb-4 text-[35px] md:text-[55px]">
              Elevate your hosting potential
            </h1>
            <p className="tracking-normal text-[25px]  md:text-3xl text-[#161615] text-center sm:text-left">
          ...
          <div className="flex justify-center sm:justify-start mb-20">
            <button className="sm:mt-10 text-white main-color-bg  max-w-[470px]  px-[80px] py-[25px]  md:py-6 md:px-28 rounded-full tracking-wide">
              GET IN TOUCH WITH US
            </button>
          </div>
          <div className="my-20 lg:-mt-44 lg:flex justify-around items-center  gap-20 ">
            <div className="grid grid-cols-2 items-center gap-8 ">
              <div className="py-5 flex flex-col justify-center items-center gap-4 tracking-wide">
      ...
      <div className="bg-[#DDDDDD] -mb-48 clip-path-top">
        <div className="container mx-auto pb-36 pt-28 px-6">
          <h1 className="text-[34px] main-color pt-20 pb-16">
