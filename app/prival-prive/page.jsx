...
import prop1 from "@/public/images/propertyDetails/prival-prive/1.jpg";
import prop2 from "@/public/images/propertyDetails/prival-prive/2.jpg";
import prop3 from "@/public/images/propertyDetails/prival-prive/3.jpg";
import prop4 from "@/public/images/propertyDetails/prival-prive/4.jpg";
import prop5 from "@/public/images/propertyDetails/prival-prive/5.jpg";
import prop6 from "@/public/images/propertyDetails/prival-prive/6.jpg";
import prop7 from "@/public/images/propertyDetails/prival-prive/7.jpg";
import prop8 from "@/public/images/propertyDetails/prival-prive/8.jpg";
import prop9 from "@/public/images/propertyDetails/prival-prive/9.jpg";
import prop10 from "@/public/images/propertyDetails/prival-prive/10.jpg";
import prop11 from "@/public/images/propertyDetails/prival-prive/11.jpg";
import prop12 from "@/public/images/propertyDetails/prival-prive/12.jpg";
import prop13 from "@/public/images/propertyDetails/prival-prive/13.jpg";
import prop14 from "@/public/images/propertyDetails/prival-prive/14.jpg";
import prop15 from "@/public/images/propertyDetails/prival-prive/15.jpg";
...
const PrivalPrive = () => {
  ...
  const nextItem = () => {
    ...
    router.push(`prival-prive#item${currentItem}`);
  };
  ...
  return (
    <div className="container mx-auto sm:px-[90px] 2xl:px-[160px] py-10">
      ...
      <div className="flex mt-16 justify-between lg:justify-start items-center flex-wrap">
        ...
        <div>
          <div className="hidden lg:flex lg:ml-10">
            ...
            <Link
              href="https://wa.me/+97145750248?text=Hello%2C%20I%20am%20interested%20in%20Prival%20Prive!"
              target="_blank"
            >
        ...
        <div className="mt-5 ">
          ...
          <p className="mt-4 text-xs leading-5 lg:text-2xl">
            Enjoy a stylish experience at this centrally-located place. Stay in
            our lovely Studio apartment at Damac Maison Prive. This fully
            furnished studio is perfect for a comfortable and convenient holiday
            for a couple or a small family of 3. It is located in a prime
            location with easy access to shopping, dining and entertainment.
            Experience a stunning view of the canal and Burj Khalifa on both
            sides of our balcony view.
          </p>
      ...
      <div>
        ...
        <p className="mt-4 text-xs leading-5 lg:text-2xl">
          Accessible to Dubai Water Canal which attracts you for line of
      ...
      <div>
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="https://maps.app.goo.gl/CXcWQio17PRQh1kX7"
            target="_blank"
          >
        ...
        <div className="map-container">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3610.5606015892263!2d55.2755156!3d25.184310399999994!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f695238401f81%3A0x23fd85d6a99c78a4!2sDAMAC%20Maison%20Prive!5e0!3m2!1sen!2seg!4v1725958398945!5m2!1sen!2seg"
            width="100%"
            height="450"
            // style="border:0;"
            // allowFullscreen=""
