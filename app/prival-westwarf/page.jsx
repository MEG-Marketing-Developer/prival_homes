...
import prop1 from "@/public/images/propertyDetails/prival-westwarf/1.jpg";
import prop2 from "@/public/images/propertyDetails/prival-westwarf/2.jpg";
import prop3 from "@/public/images/propertyDetails/prival-westwarf/3.jpg";
import prop4 from "@/public/images/propertyDetails/prival-westwarf/4.jpg";
import prop5 from "@/public/images/propertyDetails/prival-westwarf/5.jpg";
import prop6 from "@/public/images/propertyDetails/prival-westwarf/6.jpg";
import prop7 from "@/public/images/propertyDetails/prival-westwarf/7.jpg";
import prop8 from "@/public/images/propertyDetails/prival-westwarf/8.jpg";
import prop9 from "@/public/images/propertyDetails/prival-westwarf/9.jpg";
import prop10 from "@/public/images/propertyDetails/prival-westwarf/10.jpg";
import prop11 from "@/public/images/propertyDetails/prival-westwarf/11.jpg";
import prop12 from "@/public/images/propertyDetails/prival-westwarf/12.jpg";
import prop13 from "@/public/images/propertyDetails/prival-westwarf/13.jpg";
import prop14 from "@/public/images/propertyDetails/prival-westwarf/14.jpg";
import prop15 from "@/public/images/propertyDetails/prival-westwarf/15.jpg";
import prop16 from "@/public/images/propertyDetails/prival-westwarf/16.jpg";
...
const PrivalWestWarf = () => {
  ...
  const items = [
    ...
    { name: "item16", img: prop16, alt: "prop16" },
  ];
  const services = [
  ...
  const nextItem = () => {
    ...
    router.push(`prival-westwarf#item${currentItem}`);
  };
    ...
    <div className="container mx-auto sm:px-[90px] 2xl:px-[160px] py-10">
      ...
      <div className="flex mt-16 justify-between lg:justify-start items-center flex-wrap">
        ...
        <div className="mt-5 ">
          ...
          <p className="mt-4 text-xs leading-5 lg:text-2xl">
            This unique place has a style all its own. Its Canal Panoramic view
            is a stunning abode, offering a picturesque vista that captures the
            serene beauty of Business Bay Canal from all angles. The first thing
            that catches your eye is the expansive view of the canal through the
            floor-to-ceiling windows that adorn the living area. The natural
            light floods in, creating an airy and inviting atmosphere. The
            living room is positioned strategically to offer uninterrupted
            sightlines of the tranquil water
          </p>
      ...
      <h1 className="text-lg lg:text-4xl font-blissful main-color tracking-widest mb-6">
        ...
        <ul className="list-disc text-xs lg:text-xl ml-4">
          ...
          <li>Smoking Vape or E-cigarretes are not allowed </li>
          <li>Quiet Hours will be from 10:00 pm til 9:00 am </li>
          <li>Maximum Guests - 3 pax </li>
      ...
      <div>
        <div className="flex justify-between items-center ">
          ...
          <Link
            href="https://maps.app.goo.gl/v7oHRhZSDbSkqRYQ7"
            target="_blank"
          >
